        ...
        <div class="grid grid-cols-2 gap-6 mt-4">
                ...
                <!-- BEGIN: Form Layout -->
                  ...
                  <div style="border-right:1px solid #b0b0b033;padding-right:30px">
                        <div>
                        <label>Title</label>
                        <input type="text" class="input w-full border mt-2" name="title" value="{{$blog->title}}"
                    ...
                    <div class="mt-2">
                        ...
                        <input type="text" class="input w-full border mt-2" name="added_by" value="{{$blog->added_by}}"
