...
@section('content')
    ...
    <form method="POST" action="{{ route('condition.update',$term->id) }}">
        @csrf
        @method('PATCH')
                ...
                <div class="intro-y box p-5">
                    <div>
                        ...
                        <input type="text" class="input w-full border mt-2" name="condition_title"
                               placeholder="Input title" value="{{$term->condition_title}}">
                    ...
                    <div class="mt-3">
                        ...
                        <textarea class="form-control" id="summary-ckeditor"
                                  name="condition_description">{!! $term->condition_description !!}</textarea>
