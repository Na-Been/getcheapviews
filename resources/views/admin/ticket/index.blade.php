...
@section('content')
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-no-wrap items-center mt-2">
            <a href="">
                <button class="button text-white bg-theme-6 shadow-md mr-2">Delete All Tickets</button>
            </a>
            <div class="dropdown">
            ...
            <table class="table table-report -mt-2" id="example" style="width:100%">
                ...
                @foreach($tickets as $ticket)
                    <tr class="intro-x">
                        ...
                        <td class="text-center font-medium whitespace-no-wrap">
                            {!! Str::limit(ucfirst($ticket->subject), 20) !!}
                        </td>
                        <td class="table-report__action w-56">
                            <div class="flex justify-center items-center">
                                <a class="flex items-center mr-3 editSubCategory"
                                   href="{{route('condition.edit',$ticket->id)}}">
                                    <i data-feather="eye"
                                       class="w-4 h-4 mr-1"></i> view
                                </a>
                                <a class="flex items-center text-theme-6 deleteTicket" href="javascript:;"
                                   data-toggle="modal"
                                   data-value="{{$ticket->id}}" data-target="#delete-confirmation-modal"> <i
        ...
        <div class="modal" id="delete-confirmation-modal">
            <div class="modal__content">
                ...
                <form method="POST" action="{{route('destroy.user.ticket')}}">
                    @csrf
                    @method('DELETE')
                    <div class="px-5 pb-8 text-center">
                        <input type="hidden" name="ticket_id" class="ticket">
