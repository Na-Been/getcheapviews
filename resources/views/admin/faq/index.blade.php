            ...
            <table class="table table-report -mt-2" id="example" style="width:100%">
                ...
                @foreach($questions as $question)
                    <tr class="intro-x">
                        ...
                        <td class="text-center font-medium whitespace-no-wrap">
                            {!! Str::limit(ucfirst($question->answer),20) !!}
                        </td>
                        ...
                        <td class="table-report__action w-56">
                            <div class="flex justify-center items-center">
                                ...
                                <a class="flex items-center text-theme-6 deleteSubCategory" href="javascript:;"
                                   data-toggle="modal"
                                   data-value="{{$question->id}}" data-target="#delete-confirmation-modal"> <i
                ...
                @if(count($questions)>0)
                    <form method="POST" action="{{route('question.destroy',$question->id)}}">
                        ...
                        <div class="px-5 pb-8 text-center">
                            <input type="hidden" name="question_id" id="question_id" class="question">
