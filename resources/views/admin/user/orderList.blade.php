...
@section('pageName','User Order List')
@section('sidebar')
    @parent
@stop
@section('content')
                ...
                @foreach($orders as $order)
                    ...
                    <tr class="intro-x">
                        ...
                        <td class="font-medium whitespace-no-wrap">
                            ...
                            @else
                                <div class="flex items-center justify-center text-theme-1"><i
                                        data-feather="alert-circle" class="w-4 h-4 mr-2"></i><strong>No Status
                                        Yet</strong>
                                </div>
                            @endif
                        </td>
                        <td class="table-report__action w-56">
                            <div class="flex justify-center items-center">
                                <a class="flex items-center mr-3"
                                   href="{{route('view.single.order.status',$order->id)}}">
                                    <i data-feather="check-square"
                                       class="w-4 h-4 mr-1"></i> Change Status
                                </a>
                                <a class="flex items-center text-theme-6 deleteOrder" href="javascript:;"
                                   data-toggle="modal"
                                   data-target="#delete-confirmation-modal"
                                   data-value="{{$order->id}}"> <i data-feather="trash-2"
