        ...
        <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
            <table class="table table-report -mt-2" id="example" style="width:100%">
                ...
                <tr>
                    ...
                    <th class="text-center whitespace-no-wrap">TITLE & SUB TITLE</th>
                ...
                @foreach($sliders as $slider)
                    <tr class="intro-x">
                        ...
                        <td>
                            <a href="" class="font-medium whitespace-no-wrap">{{$slider->title}}</a>
                            <div class="text-gray-600 text-xs whitespace-no-wrap">{{$slider->sub_title}}</div>
                        </td>
                        <td class="text-center">{{$slider->rank}}</td>
                        @if($slider->status == 1)
                            <td class="w-40">
                        ...
                        <td class="table-report__action w-56">
                            <div class="flex justify-center items-center">
                                <a class="flex items-center mr-3" href="{{route('slider.edit',$slider->id)}}"> <i data-feather="check-square"
